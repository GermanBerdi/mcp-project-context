...
mcpServer.registerTool(
  getDatabaseConnectionByIdTool.toolName,
  getDatabaseConnectionByIdTool.config,
  getDatabaseConnectionByIdTool.cb,
);
mcpServer.registerTool(
...
mcpServer.registerTool(
  ...
  updateDatabaseConnectionTool.config,
  updateDatabaseConnectionTool.cb,
);

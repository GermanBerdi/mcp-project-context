...
export const createReqSchema = z
  ...
  .extend({
    project_status: rowSchema.project_status
      .optional()
      .describe(
        "The initial status of the project. Defaults to 'active' if not specified. Possible values are: 'active', 'paused', 'archived', 'completed'",
      ),
  })
  .describe(

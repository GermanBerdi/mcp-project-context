...
const config: models.types.mcpServer.ToolConfig<typeof models.schemas.projects.createReq> = {
  description:
    "Creates a new project in the database with a name, description, and optional status. Use this to initialize a project for tracking context, notes, and progress. Projects help maintain continuity across AI agent sessions.",

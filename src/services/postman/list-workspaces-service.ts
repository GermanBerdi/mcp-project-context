...
export const listWorkspaces = async (): Promise<models.types.postman.ListWorkspacesRes> => {
  ...
  try {
    ...
    const validatedData = models.schemas.postman.listWorkspacesRes.parse(data);
